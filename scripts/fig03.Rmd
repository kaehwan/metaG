...
vcf <- paste0(path, list.files(path, pattern=".vcf")) %>% 
  ...
  pivot_longer(cols=starts_with("/mnt/ab2/common/illumina/metaG_natural/align2ref/"), 
               names_to="Sample", 
               names_prefix="/mnt/ab2/common/illumina/metaG_natural/align2ref/", 
               values_to="Record", 
               values_drop_na=TRUE) %>% 
  rename(CHROM="#CHROM") %>% 
